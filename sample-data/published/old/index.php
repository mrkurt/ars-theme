<?
    ...
    'http://kurt.staging.arstechnica.com/published/old/content/', 
    ));
      $_resource->ad_category = false;
      $_resource->entry_count = 0;
      $_resource->category_root_url = 'http://kurt.staging.arstechnica.com/published/old/';
      $_resource->archives = new ResourceList(array());
      $_resource->basename = 'old';
      $_resource->feed_url = false;
      $_resource->url = 'http://kurt.staging.arstechnica.com/published/old/';
