<?
    ...
    require_once('/home/kurt/ars-technica-mt-bits/published/includes_c/classes.inc.php');
      ...
      $_resource->entries = new ResourceList(array('http://kurt.staging.arstechnica.com/published/gaming/news/2007/11/soul-calibur-legends-goes-gold-to-much-skepticism.php'));//Category
      ...
      $_resource->archives = new ResourceList(array('http://kurt.staging.arstechnica.com/published/business/virtualization/2007/', ));
      $_resource->basename = 'virtualization';
      $_resource->feed_url = false;
      $_resource->url = 'http://kurt.staging.arstechnica.com/published/business/virtualization/';
