<?
    ...
    require_once('/home/kurt/ars-technica-mt-bits/published/includes_c/classes.inc.php');
      ...
      $_resource->archives = new ResourceList(array('http://kurt.staging.arstechnica.com/published/microsoft/news/2007/08/24/', ));
      $_resource->basename = 'news';
      $_resource->feed_url = false;
      $_resource->url = 'http://kurt.staging.arstechnica.com/published/microsoft/news/2007/08/';
