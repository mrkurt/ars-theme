<?
    ...
    'http://kurt.staging.arstechnica.com/published/microsoft/guides/', 'http://kurt.staging.arstechnica.com/published/microsoft/news/', 'http://kurt.staging.arstechnica.com/published/microsoft/reviews/', 
      ...
      $_resource->archives = new ResourceList(array('http://kurt.staging.arstechnica.com/published/microsoft/2007/09/', 'http://kurt.staging.arstechnica.com/published/microsoft/2007/08/', ));
      $_resource->basename = 'microsoft';
      $_resource->feed_url = false;
      $_resource->url = 'http://kurt.staging.arstechnica.com/published/microsoft/2007/';
