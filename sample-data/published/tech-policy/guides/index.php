<?
    ...
    require_once('/home/kurt/ars-technica-mt-bits/published/includes_c/classes.inc.php');
      ...
      $_resource->name = 'Tech Policy/Guides';
      $_resource->children = new ResourceList(array(
    
    ));
      $_resource->ad_category = false;
      $_resource->entry_count = 0;
      $_resource->category_root_url = 'http://kurt.staging.arstechnica.com/published/tech-policy/guides/';
      $_resource->archives = new ResourceList(array());
      $_resource->basename = 'guides';
      $_resource->feed_url = false;
      $_resource->url = 'http://kurt.staging.arstechnica.com/published/tech-policy/guides/';
