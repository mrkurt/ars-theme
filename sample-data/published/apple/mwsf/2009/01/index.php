<?
    ...
    require_once('/home/kurt/ars-technica-mt-bits/published/includes_c/classes.inc.php');
      ...
      $_resource->archives = new ResourceList(array('http://kurt.staging.arstechnica.com/published/apple/mwsf/2009/01/21/', ));
      $_resource->basename = 'mwsf';
      $_resource->feed_url = false;
      $_resource->url = 'http://kurt.staging.arstechnica.com/published/apple/mwsf/2009/01/';
